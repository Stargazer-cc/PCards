...
- **Tag System**: Add tags to cards for easy categorization and filtering. Now, clicking a card tag in note view will automatically search for that tag in the search box, just like in the gallery view.
...
**Q: Why does clicking a card tag do nothing?**
A: Now, whether in the gallery or note view, clicking a card tag will automatically search for that tag in the search box, providing a native-like tag search experience.
...
- **Douban Cookie**: Used to fetch more complete data from Douban. There is a 'How to get' button next to the setting, which links to [How to get Douban Cookie](https://blog.csdn.net/m0_62205683/article/details/146944749).